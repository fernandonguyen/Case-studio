...
RedT.Matrix2D.prototype.update = function(a, b, c, d, tx, ty) {
	this.a  = a;
	this.b  = b;
	this.c  = c;
	this.d  = d;
...
RedT.Matrix2D.prototype.updateTransform = function(x, y, scaleX, scaleY, rotation, skewX, skewY, regX, regY) {
	let cos = 1;
	let sin = 0;
	if (rotation%360) {
